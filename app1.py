...
st.set_page_config(page_title="Ask to Operational Manuel PART-A", page_icon=":sparkles:")
st.markdown("<h1 style='text-align: center;'>Pilot Chatbot 🌞</h1>", unsafe_allow_html=True)
